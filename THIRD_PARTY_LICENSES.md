...
This repository is licensed under the MIT License. This file summarizes the third-party Python packages present in the project-local `.venv` used for the final publication check on 2026-05-01.

Scope notes:

- The inventory below reflects the installed packages in `.venv`, which matches the pinned direct dependencies in `requirements.txt` plus their resolved transitive dependencies.
...
| iniconfig | 2.3.0 | no | MIT | Permissive |
...
| pluggy | 1.6.0 | no | MIT | Permissive |
...
| pytest | 9.0.2 | yes | MIT | Permissive |
