...
TRANSLATIONS: dict[LanguageCode, dict[str, str]] = {
    "es": {
        ...
        "sidebar.run_analysis": "Analizar configuración",
        ...
        "summary.empty_state": "Ajusta el escenario en la barra lateral o en el plano y ejecuta el análisis.",
        ...
        "editor.hint": "El análisis solo se recalcula al terminar el gesto.",
        "editor.hint.dragging": "Al soltar el ratón se recalcula la simulación.",
        "editor.hint.commit": "Análisis actualizado tras confirmar el gesto.",
    ...
    "en": {
        ...
        "sidebar.run_analysis": "Analyze layout",
        ...
        "summary.empty_state": "Adjust the scenario in the sidebar or on the floor plan and run the analysis.",
        ...
        "editor.hint": "The analysis is only recalculated after the gesture ends.",
        "editor.hint.dragging": "The simulation is recalculated when you release the mouse.",
        "editor.hint.commit": "Analysis updated after confirming the gesture.",
